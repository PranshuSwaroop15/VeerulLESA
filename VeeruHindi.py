...
def translate_response(response_text, target_language="hi"):
...
def generate(prompt):
    ...
    # return message
    message=translate_response(message)
    speak(message)
...
if __name__ == "__main__":
    ...
    speak("नमस्कार, यह आपकी कानूनी डिजिटल सहायक Veeru है, मैं आपकी कैसे मदद कर सकती हूं?")
